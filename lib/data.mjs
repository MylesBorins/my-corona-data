...
const CSV_PATH = '../third_party/coronavirus-data/archive/case-hosp-death.csv';
...
function getOntarioData() {
  return require('../third_party/api.covid19tracker.ca/covidtracker.ca-ontario-data.json').data;
}
...
function getManualTorontoData() {
  return require('../third_party/toronto-twitter-data/manual-toronto-data.json');
}
