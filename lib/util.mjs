...
function createWindows(arr, windowLength = DEFAULT_WINDOW_LENGTH, totalLength = 30) {
  const result = [];
...
function printWindows(windowTitle, windows, windowLength = DEFAULT_WINDOW_LENGTH, totalLength = 30) {
  const step = windowLength / 2;
